...
const FoodMood = ({ currentCity }) => {
    ...
    const dishes = [
        { id: 'blr_f1', name: 'Benne Dosa', origin: 'Bengaluru', city: 'blr', tags: ['Crispy', 'Butter'], desc: 'The legendary Davangere style butter dosa.', img: 'https://placehold.co/600x400/8E391F/FFFFFF?text=Benne+Dosa' },
        { id: 'bom_f1', name: 'Vada Pav', origin: 'Mumbai', city: 'bom', tags: ['Street', 'Spicy'], desc: 'The undisputed king of Mumbai street food.', img: 'https://placehold.co/600x400/FF4D00/FFFFFF?text=Vada+Pav' },
        { id: 'del_f1', name: 'Chole Bhature', origin: 'Delhi', city: 'del', tags: ['Hearty', 'Spicy'], desc: 'Fluffy bhatures served with spicy chickpea curry.', img: 'https://placehold.co/600x400/6F4E37/FFFFFF?text=Chole+Bhature' },
        { id: 'maa_f1', name: 'Idli Sambar', origin: 'Chennai', city: 'maa', tags: ['Healthy', 'Morning'], desc: 'Soft steamed rice cakes with drumstick sambar.', img: 'https://placehold.co/600x400/00A86B/FFFFFF?text=Idli+Sambar' },
        { id: 'ccu_f1', name: 'Puchka', origin: 'Kolkata', city: 'ccu', tags: ['Tangy', 'Street'], desc: 'Paper-thin shells filled with magic water.', img: 'https://placehold.co/600x400/FF4D00/FFFFFF?text=Puchka' },
        { id: 'hyd_f1', name: 'Hyderabadi Biryani', origin: 'Hyderabad', city: 'hyd', tags: ['Royal', 'Aromatic'], desc: 'World famous slow-cooked dum biryani.', img: 'https://placehold.co/600x400/8E391F/FFFFFF?text=Biryani' },
        { id: 'pnq_f1', name: 'Puneri Misal', origin: 'Pune', city: 'pnq', tags: ['Spicy', 'Crunchy'], desc: 'A complex, spicy sprout curry topped with farsan.', img: 'https://placehold.co/600x400/FF4D00/FFFFFF?text=Misal' },
        { id: 'amd_f1', name: 'Dhokla', origin: 'Ahmedabad', city: 'amd', tags: ['Light', 'Steamed'], desc: 'Spongy, savory gram flour cakes.', img: 'https://placehold.co/600x400/FFCC00/000000?text=Dhokla' },
        { id: 'jai_f1', name: 'Dal Baati Churma', origin: 'Jaipur', city: 'jai', tags: ['Traditional', 'Rich'], desc: 'The soul of Rajasthan in a single plate.', img: 'https://placehold.co/600x400/8E391F/FFFFFF?text=Dal+Baati' },
        { id: 'cok_f1', name: 'Appam with Stew', origin: 'Kochi', city: 'cok', tags: ['Creamy', 'Breakfast'], desc: 'Lacy pancakes served with coconut milk stew.', img: 'https://placehold.co/600x400/00A86B/FFFFFF?text=Appam+Stew' },
        { id: 'lko_f1', name: 'Tunday Kabab', origin: 'Lucknow', city: 'lko', tags: ['Royal', 'Legacy'], desc: 'Melt-in-mouth kebabs from the Nawabi era.', img: 'https://placehold.co/600x400/6F4E37/FFFFFF?text=Tunday+Kabab' },
        { id: 'vns_f1', name: 'Banarasi Paan', origin: 'Varanasi', city: 'vns', tags: ['Divine', 'Herbal'], desc: 'The ultimate culinary ritual of the holy city.', img: 'https://placehold.co/600x400/00A86B/FFFFFF?text=Banarasi+Paan' },
        { id: 'atq_f1', name: 'Amritsari Kulcha', origin: 'Amritsar', city: 'atq', tags: ['Butter', 'Crispy'], desc: 'Flaky flatbread baked in traditional tandoors.', img: 'https://placehold.co/600x400/FFCC00/000000?text=Amritsari+Kulcha' },
        { id: 'ind_f1', name: 'Poha Jalebi', origin: 'Indore', city: 'ind', tags: ['Zesty', 'Sweet'], desc: 'The cleanest city\'s most colorful breakfast.', img: 'https://placehold.co/600x400/FF4D00/FFFFFF?text=Poha+Jalebi' },
        { id: 'tny_f1', name: 'Tirunelveli Halwa', origin: 'Tirunelveli', city: 'tny', tags: ['Sweet', 'Iconic'], desc: 'Glistening ghee-rich wheat halwa.', img: 'https://placehold.co/600x400/6F4E37/FFFFFF?text=Halwa' },
        { id: 'cjb_f1', name: 'Annapoorna Sambar', origin: 'Coimbatore', city: 'cjb', tags: ['Heritage', 'Flavor'], desc: 'A unique yellow lentil stew from the West.', img: 'https://placehold.co/600x400/FFCC00/000000?text=Sambar' },
        { id: 'trz_f1', name: 'Srirangam Puliyodharai', origin: 'Trichy', city: 'trz', tags: ['Temple', 'Tangy'], desc: 'Divine tamarind rice from the island temple.', img: 'https://placehold.co/600x400/6F4E37/FFFFFF?text=Puliyodharai' },
        { id: 'ixm_f1', name: 'Jigarthanda', origin: 'Madurai', city: 'ixm', tags: ['Cooling', 'Sweet'], desc: 'A heart-cooling drink for the city that never sleeps.', img: 'https://placehold.co/600x400/8E391F/FFFFFF?text=Jigarthanda' },
        { id: 'trv_f1', name: 'Pazhampori', origin: 'Trivandrum', city: 'trv', tags: ['Fried', 'Tropical'], desc: 'Golden banana fritters, a Malayali mood.', img: 'https://placehold.co/600x400/FFCC00/000000?text=Pazhampori' },
        { id: 'ixc_f1', name: 'Paneer Tikka', origin: 'Chandigarh', city: 'ixc', tags: ['Grilled', 'Fresh'], desc: 'Charcoal grilled cottage cheese with Punjabi zest.', img: 'https://placehold.co/600x400/FF4D00/FFFFFF?text=Paneer+Tikka' },
    ];
